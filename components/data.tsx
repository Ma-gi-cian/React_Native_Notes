const poses = [
    ...
    },
    {
        ...
        "url_svg": "https://res.cloudinary.com/dko1be2jy/image/upload/fl_sanitize/v1676483074/yoga-api/4_qq6nxw.svg",
        "url_png": "https://res.cloudinary.com/dko1be2jy/image/upload/fl_sanitize/v1676483074/yoga-api/4_qq6nxw.png",
...
const notes = [
  {
    ...
    "description": "A timeless classic set in the Jazz Age, *The Great Gatsby* explores themes of wealth, class, love, and the American Dream. The story revolves around the mysterious and enigmatic Jay Gatsby and his obsession with the beautiful Daisy Buchanan.",
    "keyPoints": [
  ...
  },
  {
    ...
    "description": "A powerful coming-of-age story set in the American South during the Great Depression, *To Kill a Mockingbird* explores themes of racial injustice, morality, and empathy. The story is told through the eyes of a young girl named Scout Finch.",
    "keyPoints": [
      "Racial Injustice",
      "Loss of Innocence",
  ...
  {
    "title": "1984",
    "description": "A dystopian novel set in a totalitarian state called Oceania, *1984* explores themes of totalitarianism, surveillance, and the manipulation of language. The protagonist, Winston Smith, rebels against the oppressive regime.",
    "keyPoints": [
  ...
  },
  {
    ...
    "description": "A classic romance novel set in 19th-century England, *Pride and Prejudice* explores themes of love, marriage, social class, and the expectations of society. The story follows the lives of the Bennet sisters, particularly Elizabeth Bennet and her complex relationship with Mr. Darcy.",
    "keyPoints": [
      "The Importance of Social Status",
      "The Power of First Impressions",
      "The Role of Pride and Prejudice",
      "The Power of Love to Overcome Obstacles",
      "The Satire of Society and Manners"
    ]
  },
  {
    "title": "The Lord of the Rings",
    "description": "An epic high-fantasy novel set in Middle-earth, *The Lord of the Rings* follows the journey of Frodo Baggins and the Fellowship of the Ring as they seek to destroy the One Ring to defeat the Dark Lord Sauron.",
    "keyPoints": [
      "The Power of Friendship",
      "The Struggle Between Good and Evil",
      "The Importance of Courage and Sacrifice",
      "The Beauty of Nature and the Wilderness",
      "The Dangers of Power and Corruption"
    ]
  },
  {
    "title": "The Alchemist",
    "description": "A philosophical novel that explores themes of personal legend, self-discovery, and the power of dreams. The protagonist, Santiago, embarks on a journey to fulfill his destiny and find a treasure.",
    "keyPoints": [
      "The Importance of Following Your Dreams",
      "The Power of the Universe and Destiny",
      "The Value of Listening to Your Heart",
  ...
  },
  {
    ...
    "description": "A philosophical fable that explores themes of childhood, love, loss, and the human condition. The Little Prince, a young boy from another planet, visits Earth and learns about the complexities of human life.",
    "keyPoints": [
      "The Importance of Imagination and Wonder",
      "The Dangers of Materialism and Adult Worldview",
      "The Power of Love and Friendship",
      "The Importance of Taking Care of Others",
      "The Search for Meaning and Purpose"
    ]
  },
  {
    "title": "The Hitchhiker's Guide to the Galaxy",
    "description": "A comedic science fiction series that follows the adventures of Arthur Dent and his alien friend Ford Prefect as they travel through the galaxy. The series satirizes bureaucracy, technology, and the human condition.",
    "keyPoints": [
      ...
      "The Dangers of Technology and Progress"
    ]
  },
  {
    "title": "Sapiens: A Brief History of Humankind",
    "description": "A non-fiction book that explores the history of human civilization from our origins as hunter-gatherers to our current global society. The book delves into the cognitive revolution, the agricultural revolution, and the scientific revolution.",
    "keyPoints": [
      "The Unique Cognitive Abilities of Humans",
      "The Impact of Agriculture on Human Society",
      "The Rise of Empires and Civilizations",
      "The Role of Science and Technology in Human History",
      "The Challenges and Opportunities Facing Humanity"
    ]
  },
  {
    "title": "Thinking, Fast and Slow",
    "description": "A non-fiction book that explores the two systems of thinking: System 1, which is fast, intuitive, and emotional, and System 2, which is slow, deliberate, and logical. The   book explains how these two systems influence our judgments and decisions.",
    "keyPoints": [
      "The Biases and Errors of System 1 Thinking",
      "The Importance of Critical Thinking and Rationality",
